...
Since denomiator will always be greater than numerator and positive.
...
Meaing whenver $z \geq N$ where $N > \log\!\left(\frac{1}{\epsilon}\right)$ we have 
...
specifcally choose $N > \log\!\left(\frac{1 - \epsilon}{\epsilon}\right)$
...
Now that we have proved the limit behavior of p and we have defined it as the probabilty
...
Then to find the partial derivavite of the gradient we have 
...
Our model reaches its optimum specifcally when
